...
// Индикатор сети: на телефоне (портрет и альбом) — SVG-иконка; на планшете и ПК — текст в #navNetStatusTxt (см. style.css).
...
<div class="wrap">
  ...
  <div class="card">
    ...
    <p>Главный экран. Прогресс дня, карточки привычек, виджеты.
    Если активна цель — её привычки идут первым блоком, твои собственные — ниже отдельно.</p>
  </div>

  <div class="card">
    <div class="card-title">✅ Привычки</div>
    <p>Список всех привычек. Добавляй новые, отправляй в архив, удаляй.
    Здесь же включается и выключается дневник настроения.</p>
  </div>
  ...
  <div class="card">
    ...
    При включённом дневнике настроения — линейный график настроения.</p>
  </div>

  <div class="card">
    <div class="card-title">🏅 Значки</div>
    <p>Персонаж и достижения. Стадии развития: Начало → В ритме → Устойчивость →
    Сила привычки → Опора → Мастер. Значки получаешь за конкретные результаты.</p>
  </div>

  <h2>Цели и дорожные карты</h2>
  ...
  <div class="card">
    ...
    автоматически откроется следующий с новыми привычками.</p>
    <div class="divider"></div>
    <p>Три этапа × 21 день = <strong>63 дня</strong> до полного результата.
    В любой момент можно остановить цель — твои привычки вернутся из архива.</p>
  </div>

  <div class="card">
    <div class="card-title">Описания привычек</div>
    <p>Под каждой привычкой цели есть объяснение: <em>зачем</em> эта привычка работает
    (научное обоснование) и отметка с частотой выполнения.
    Это помогает не просто делать — а понимать, почему это меняет жизнь.</p>
  </div>
  ...
  <div class="card">
    ...
    <p>Нажми кнопку справа — карточка перевернётся. Покажет время отметки и кнопку «отменить».
    Отмечай каждый день чтобы наращивать серию.</p>
    <div class="divider"></div>
  ...
  <div class="card">
    ...
    <p>Две кнопки: ✓ Выдержал или ✕ Был срыв. Карточка перевернётся зелёной или красной.
    Нажми на цвет чтобы отменить.</p>
    <div class="divider"></div>
  ...
  <div class="card">
    ...
    <p>Полезная привычка с расписанием (например «Будни»). В выходной она становится бонусной —
    можно отметить добровольно и получить дополнительные очки.</p>
    <div class="divider"></div>
  ...
  <div class="card">
    <p>При создании привычки выбери расписание: каждый день, будни, выходные или свои дни.
    В незапланированный день привычка не влияет на прогресс, но её можно отметить как бонусную.</p>
    <div class="divider"></div>
    <p>Привычки из цели не имеют расписания — они активны каждый день.</p>
  </div>

  <h2>Новости и обновления</h2>

  <div class="card">
    <p>📰 Кнопка <strong>Новости</strong> в меню ☰ — контентные советы по привычкам и
    список всех обновлений приложения.</p>
    <div class="divider"></div>
    <p>При выходе новой версии появляется компактная модалка «Что нового» — закрывается крестом
    и больше не показывается. Всё это всегда доступно в ленте Новостей.</p>
  </div>

  <h2>Данные и резервные копии</h2>

  <div class="card">
    <p>Данные хранятся в браузере на этом устройстве. Очистка данных браузера может привести
    к потере истории.</p>
    <div class="divider"></div>
    <p>💾 <strong>Сохранить копию</strong> — скачать файл резервной копии (.json)<br>
    📂 <strong>Загрузить копию</strong> — восстановить из файла.<br>
  ...
  <div class="card">
    ...
    Шесть тем: ☀️ Светлая, 🌙 Тёмная, 🌿 Лес, ◈ Veloce,
    🎭 Deco Noir, 🏛️ Ivory.</p>
  </div>
...
function setTheme(theme, save = true) {
  const allowed = new Set(['light', 'dark', 'forest', 'veloce', 'deco-noir', 'ivory']);
